...
<?php
	...
	if(isset($_POST['do']) && $_POST['do'] == "Add")
	{
        ...
        $category_duration = test_input($_POST['category_duration']);
        ...
        elseif($checkItem == 0)
        {
            ...
            $stmt = $con->prepare("insert into service_categories(category_name,category_duration) values(?,?) ");
            $stmt->execute(array($category_name, $category_duration));
