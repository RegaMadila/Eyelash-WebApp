...
$("#add_category_bttn").click(function () {
  ...
  var category_duration = $("#category_duration_input").val();
  var do_ = "Add";
...
// const elServiceOptions = document.getElementsByClassName("service-options");
// Array.from(elServiceOptions).forEach((elServiceOption) => {
//   elServiceOption.addEventListener("change", (ev) => {
//     const appointmentId = ev.target.getAttribute("data-appointment-id");
...
//   if (!appointmentId || !serviceId) return;
//   $.ajax({
//     url: "ajax_files/appointment_ajax.php",
//     method: "POST",
//     data: {
//       do: "Update Service Name",
//       appointment_id: appointmentId,
//       service_id: serviceId,
//     },
//     success: function (data) {
//       swal("Updated", "Service has been updated successfully!", "success");
//     },
//     error: function (xhr, status, error) {
//       alert(
//         "AN ERROR HAS BEEN ENCOUNTERED WHILE TRYING TO EXECUTE YOUR REQUEST"
...
function onSelectedServiceOption(ev) {
  const appointmentId = ev.target.getAttribute("data-appointment-id");
  const serviceId = ev.target.value;
  if (!appointmentId || !serviceId) return;
  $.ajax({
